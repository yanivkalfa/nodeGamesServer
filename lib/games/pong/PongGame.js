module.exports = function(_s){
    ...
    PongGame.prototype.join = function(p){
        ...
        console.log(self.timers.killGame);
        if(this.checkPlayers()){
            console.log('both players');

            clearTimeout(self.timers.killGame);
            console.log(self.timers.killGame);
            this.outRouter.gs();
            self.timers.gameStart = setTimeout(function(){
                player.inRouter.init();
                self.start();
                clearTimeout(self.timers.gameStart);
            }, 20000);
        }
    };
    ...
    PongGame.prototype.start = function(){
        ...
        self.mainLoop.start();
        self.timers.aIStart = setTimeout(function(){
            ball.ai.start();
            clearTimeout(self.timers.aIStart);
        }, 1000);
    };
