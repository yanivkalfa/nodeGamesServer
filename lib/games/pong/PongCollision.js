module.exports = function(_s){
    ...
    PongCollision.prototype.check = function(nextPoint, moveDist, movDir){
        ...
        }else if(this.entity.position.y >= this.game.canvas.height - this.entity.dimensions.height - 2 && movDir > 0){
            this.entity.position.y = this.game.canvas.height - this.entity.dimensions.height -2;
            this.entity.velocity.x = 0;
            this.entity.velocity.y = 0;
        }
